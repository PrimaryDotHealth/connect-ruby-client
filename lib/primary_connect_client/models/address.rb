...
module PrimaryConnectClient
  class Address
    attr_accessor :street_address_1
    ...
    def initialize(attributes = {})
      ...
      if attributes.key?(:'street_address_1')
        self.street_address_1 = attributes[:'street_address_1']
      end

      if attributes.key?(:'street_address_2')
    ...
    def ==(o)
      ...
      self.class == o.class &&
          street_address_1 == o.street_address_1 &&
    ...
    def hash
      [street_address_1, street_address_2, city, state_code, zip, county, country_code, time_zone].hash
    end
