...
module PrimaryConnectClient
  class Order
    ...
    def self.openapi_types
      {
        ...
        :'specimen' => :'OrderSpecimen',
        :'procedure' => :'OrderProcedure',
        :'ordering_provider' => :'Provider',
        :'result_copy_providers' => :'Array<Provider>',
        :'ordering_facility' => :'OrderOrderingFacility',
        :'priority' => :'OneOfstring',
        :'diagnoses' => :'Array<OrderDiagnoses>',
        :'clinical_comments' => :'String',
        :'notes' => :'Array<String>',
        :'clinical_info' => :'Array<OrderClinicalInfo>',
        :'results_status' => :'OneOfstring',
        :'response_flag' => :'OneOfstring'
      }
    end
    ...
    def valid?
      status_validator = EnumAttributeValidator.new('OneOfstring', ["STATUS_NEW", "STATUS_UPDATE", "STATUS_CANCEL", "STATUS_RESULTED"])
      return false unless status_validator.valid?(@status)
      priority_validator = EnumAttributeValidator.new('OneOfstring', ["PRIORITY_STAT", "PRIORITY_ASAP", "PRIORITY_ROUTINE", "PRIORITY_PREOPERATIVE", "PRIORITY_TIMING_CRITICAL"])
      return false unless priority_validator.valid?(@priority)
      results_status_validator = EnumAttributeValidator.new('OneOfstring', ["FINAL", "PRELIMINARY", "IN_PROCESS", "CORRECTED", "CANCELED", "UNAVAILABLE"])
      return false unless results_status_validator.valid?(@results_status)
      response_flag_validator = EnumAttributeValidator.new('OneOfstring', ["ACKNOWLEDGEMENT", "EXCEPTIONS", "REPLACEMENTS", "ASSOCIATED_SEGMENTS", "CONFIRMATIONS"])
    ...
    def status=(status)
      validator = EnumAttributeValidator.new('OneOfstring', ["STATUS_NEW", "STATUS_UPDATE", "STATUS_CANCEL", "STATUS_RESULTED"])
    ...
    def priority=(priority)
      validator = EnumAttributeValidator.new('OneOfstring', ["PRIORITY_STAT", "PRIORITY_ASAP", "PRIORITY_ROUTINE", "PRIORITY_PREOPERATIVE", "PRIORITY_TIMING_CRITICAL"])
    ...
    def results_status=(results_status)
      validator = EnumAttributeValidator.new('OneOfstring', ["FINAL", "PRELIMINARY", "IN_PROCESS", "CORRECTED", "CANCELED", "UNAVAILABLE"])
    ...
    def response_flag=(response_flag)
      validator = EnumAttributeValidator.new('OneOfstring', ["ACKNOWLEDGEMENT", "EXCEPTIONS", "REPLACEMENTS", "ASSOCIATED_SEGMENTS", "CONFIRMATIONS"])
    ...
    def hash
      [id, application_order_id, status, transaction_date_time, collection_date_time, completion_date_time, expiration_date, specimen, procedure, ordering_provider, result_copy_providers, ordering_facility, priority, diagnoses, clinical_comments, notes, clinical_info, results_status, response_flag].hash
    end
